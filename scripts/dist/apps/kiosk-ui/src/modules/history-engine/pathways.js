...
exports.CLINICAL_PATHWAYS = exports.backPainPathway = exports.coughPathway = exports.feverPathway = exports.headachePathway = exports.abdominalPainPathway = exports.chestPainPathway = void 0;
exports.resolvePathway = resolvePathway;
// ============================================================================
// 1. CHEST PAIN PATHWAY
// ============================================================================
exports.chestPainPathway = {
    ...
    getNextQuestionId: (history, currentId) => {
        if (currentId === "cp_duration")
            return "cp_character";
        if (currentId === "cp_character")
            return "cp_radiation";
        if (currentId === "cp_radiation")
            return "cp_associated";
        if (currentId === "cp_associated")
            return "cp_history";
        return null;
    },
...
exports.abdominalPainPathway = {
    ...
    getNextQuestionId: (history, currentId) => {
        if (currentId === "ap_location")
            return "ap_duration";
        if (currentId === "ap_duration")
            return "ap_food_relation";
        if (currentId === "ap_food_relation")
            return "ap_associated";
        return null;
    },
    checkRedFlags: (history) => {
        const flags = [];
...
exports.headachePathway = {
    ...
    getNextQuestionId: (history, currentId) => {
        if (currentId === "ha_onset")
            return "ha_character";
        if (currentId === "ha_character")
...
exports.feverPathway = {
    ...
    getNextQuestionId: (history, currentId) => {
        if (currentId === "fv_duration")
            return "fv_pattern";
        if (currentId === "fv_pattern")
            return "fv_associated";
        return null;
    },
    checkRedFlags: (history) => {
        const flags = [];
...
exports.coughPathway = {
    ...
    getNextQuestionId: (history, currentId) => {
        if (currentId === "cg_type")
            return "cg_duration";
        if (currentId === "cg_duration")
            return "cg_associated";
        return null;
    },
    checkRedFlags: (history) => {
        const flags = [];
...
exports.backPainPathway = {
    ...
    getNextQuestionId: (history, currentId) => {
        if (currentId === "bp_location")
            return "bp_radiation";
        if (currentId === "bp_radiation")
            return "bp_redflags";
        return null;
    },
    checkRedFlags: (history) => {
...
exports.CLINICAL_PATHWAYS = {
    "chest_pain": exports.chestPainPathway,
    "chest_heart_lungs": exports.chestPainPathway,
    "abdominal_pain": exports.abdominalPainPathway,
    "stomach_abdomen": exports.abdominalPainPathway,
    "headache": exports.headachePathway,
    "head_brain": exports.headachePathway,
    "fever": exports.feverPathway,
    "fever_vitals": exports.feverPathway,
    "cough": exports.coughPathway,
    "throat_neck": exports.coughPathway,
    "back_pain": exports.backPainPathway,
    "spine_back": exports.backPainPathway
};
function resolvePathway(complaintKey) {
    return exports.CLINICAL_PATHWAYS[complaintKey] || exports.abdominalPainPathway;
}
