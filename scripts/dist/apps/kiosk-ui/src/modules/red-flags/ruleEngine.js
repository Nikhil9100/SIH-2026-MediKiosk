...
exports.ConfigurableRedFlagEngine = exports.DEFAULT_RED_FLAG_RULES = void 0;
/**
 ...
 */
exports.DEFAULT_RED_FLAG_RULES = [
...
class ConfigurableRedFlagEngine {
    rules;
    constructor(customRules) {
        this.rules = customRules || exports.DEFAULT_RED_FLAG_RULES;
    }
    getRules() {
        return this.rules;
    }
    ...
    evaluate(sessionId, history, complaints = []) {
        const redFlags = [];
        const triggeredRules = [];
        const detectedSymptomsSet = new Set();
...
exports.ConfigurableRedFlagEngine = ConfigurableRedFlagEngine;
